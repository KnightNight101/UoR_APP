...
class DeepSeekR1:
    """
    Interface to DeepSeek R1 8B via Ollama local model runner.
    """
    ...
    def query_llm(self, prompt: str) -> str:
        """
        Run the prompt on DeepSeek R1 8B via Ollama CLI.
        """
        try:
            ...
            print("Error running DeepSeek R1 8B via Ollama:", e)
            return ""
