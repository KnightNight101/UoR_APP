...
Gaianu’s paper ‘XXXX’ compares On-Premise data centres with Cloud solutions, providing insights that aid in addressing this project’s problem statement regarding the trade-offs between self-managed infrastructure vs. outsourced cloud services.  The paper’s emphasis on evaluating Total Cost Ownership (TCO) over the long term when choosing between infrastructure solutions \parencite{gaianuPremiseDataCenter2023a}  informed the evaluation process for this project as it aligns with the objective to identify cost-effective and operationally efficient IT infrastructure options. 
  
Cloud services allow for the dynamic scaling of resources and can adjust to meet business needs without intensive investment of capital at the onset\parencite{gaianuPremiseDataCenter2023a}. Thus, Cloud based infrastructure offers the benefit of offering operational agility and adaptability whilst also being cheaper than hosting resources locally. However, whilst requiring more investment in hardware, personnel and ongoing maintenance, On-Premises systems provide organisations with full control over infrastructure. This means XXXXX which is why this was preferred for this project. Additionally, ‘if an organization has high confidence in the capacity of internal IT resources and high confidence in their ability to deliver necessary results, then the On-Premise cost structure can be expected to save money over the longer term when compared to Cloud, ‘ demonstrating that On-Premise infrastructure can still be the most cost-effective solution if internal expertise is strong. This finding reinforces the importance placed throughout this project of building an app that’s easy to use and maintain with clear accountability and auditability that doesn’t require huge amounts of internal expertise; reducing the barrier to a cost-competitive On-Premise solution. An emphasis was placed on requiring less training, less information and maintenance to operate this software so that the benefits of On Premise solutions, which include data security and visibility, could be accessed without sacrificing cost-efficiency in this trade-off. 

Gaianu’s paper also highlights  how different stakeholders approach both systems. Vendors favour Cloud subscriptions for predictable revenue however, whilst Cloud adoption is increasing and vendors prefer it, On-Premise data centers still maintain a significant share due to regulatory, security and compliance needs. Although there are potential vendor biases in favour of Cloud systems and an increase in Cloud adoption, the comparative regulatory ease and ease of compliance offered by On-premise solutions remains a key advantage, when viewed through the lens of key grounding principles of this project, namely XXXX, ease of integration and sustained use and emphasis on data security. The paper argues that, ‘engaging the external Cloud service can free IT resources for other priorities’ which would align with this project’s strategic goals  such as resource optimisation and focusing internal IT teams on value-added tasks
