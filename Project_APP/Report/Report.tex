...
\begin{figure}[h]
\centering
\includesvg[width=\textwidth,inkscapelatex=false]{main_py.svg}
...
\begin{figure}[h]
    \centering
    % \includegraphics[width=\textwidth]{Main_qml.svg}
...
\begin{figure}[h]
    \centering
    % \includegraphics[width=\textwidth]{reset_users.svg}
...
\begin{figure}[h]
    \centering
    % \includegraphics[width=\textwidth]{print_users.svg}
...
\begin{figure}[h]
    \centering
    % \includegraphics[width=\textwidth]{backend_db.svg}
